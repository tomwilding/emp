...
plotConfig <- list(title="Synthedemic Decomposition of Robin Thicke BitTorrent Downloads", fileName="output/graphs/blurOr85/", dataFile="output/data/blur2/blurDataOr85.RData", envFile="output/data/blur2/blurEnv.RData", pat=12, rat=60)
