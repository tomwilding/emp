...
# initParams <- c(log(0.001), log(0.1), log(1000), log(0.001), log(0.1), log(1000))
...
plotConfig <- list(title="Synthedemic Decomposition of Robin Thicke BitTorrent Downloads", fileName="output/graphs/blurt1/s0/", dataFile="output/data/blurt1/blurDataFinal.RData", envFile="output/data/blur2/blurEnv.RData", pat=12, rat=60)
