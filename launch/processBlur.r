...
plotConfig <- list(title="Synthedemic Decomposition of Robin Thicke BitTorrent Downloads", fileName="output/graphs/blurt1/s0/", dataFile="output/data/blurt1/blurData15.RData", envFile="output/data/blur2/blurEnv.RData", pat=12, rat=60)
