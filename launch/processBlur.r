...
# initParams <- c(logit(1e-6, 0.001, 0.1), logit(1e-4, 0.01, 1), log(1000), 0, 
# 				logit(1e-6, 0.001, 0.1), logit(1e-4, 0.01, 1), log(1000), 0, 
# 				logit(1e-4, 0.01, 1),
# 				logit(1e-6, 0.001, 0.1), logit(1e-4, 0.01, 1), log(1000), 0,
# 				logit(1e-6, 0.001, 0.1), logit(1e-4, 0.01, 1), log(1000), 0)
...
plotConfig <- list(title="Synthedemic Decomposition of Robin Thicke BitTorrent Downloads", fileName="output/graphs/blurOT/", dataFile="output/data/blurt2/optimLogis90Beta1.RData", envFile="output/data/blur2/blurEnv.RData", pat=12, rat=60)
