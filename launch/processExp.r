...
plotConfig <- list(title="Synthedemic Decomposition of Simulated Data", fileName="output/graphs/expSingle/", dataFile="output/data/exp/expSingleData.RData", envFile="output/data/mix/mixEnv.RData", pat=5, rat=30)
