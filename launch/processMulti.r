...
plotConfig <- list(title="Synthedemic Decomposition of Simulated Data", fileName="output/graphs/sim1/", dataFile="output/data/sim/ssimData.RData", envFile="output/data/sim/simEnv.RData", pat=5, rat=30)
