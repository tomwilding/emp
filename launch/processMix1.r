...
plotConfig <- list(title="Synthedemic Decomposition of Simulated Data", fileName="output/graphs/mixOT1/", dataFile="output/data/mix/mixDataFT1t40.RData", envFile="output/data/mix/mixEnv.RData", pat=5, rat=30)
