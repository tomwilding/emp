...
initParams <- c()
# initParams <- c(log(0.001), log(0.01), log(1000), logit((34 - 40), (34 - minTruncation), 34),
				# log(0.001), log(0.01), log(1000), logit((103 - 40), (103 - minTruncation), 103))
...
plotConfig <- list(title="Synthedemic Decomposition of Simulated Data", fileName="output/graphs/mixOT1/", dataFile="output/data/mix/mixDataFT1.RData", envFile="output/data/mix/mixEnv.RData", pat=5, rat=30)
