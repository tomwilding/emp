...
plotConfig <- list(title="Synthedemic Decomposition of Simulated Data", fileName="output/graphs/mixItr1Rep/", dataFile="output/data/mix/mixItr1IR.RData", envFile="output/data/mix/mixEnv.RData", pat=15, rat=30)
