...
initParams <- c()
# initParams <- c(log(0.001), log(0.01), log(10000), logit((34 - 20), (34 - 10), 34),
				# log(0.001), log(0.01), log(10000), logit((103 - 20), (103 - 10), 103))
...
plotConfig <- list(title="Synthedemic Decomposition of Simulated Data", fileName="output/graphs/mixOT1/", dataFile="output/data/mix/mixDataFT1t10.RData", envFile="output/data/mix/mixEnv.RData", pat=5, rat=30)
