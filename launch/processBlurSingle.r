...
plotConfig <- list(title="Synthedemic Decomposition of Robin Thicke BitTorrent Downloads", fileName="output/graphs/blurSingle/", dataFile="output/data/blur/blurSingle.RData", envFile="output/data/blur2/blurEnv.RData", pat=12, rat=60)
