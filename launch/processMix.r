...
plotConfig <- list(title="Synthedemic Decomposition of Simulated Data", fileName="output/graphs/mixOT/", dataFile="output/data/mix/mixDataFTt40.RData", envFile="output/data/mix/mixEnv.RData", pat=5, rat=30)
