...
plotConfig <- list(title="Synthedemic Decomposition of Simulated Data", fileName="output/graphs/mixItr/", dataFile="output/data/mix/mixDataItr.RData", envFile="output/data/mix/mixEnv.RData", pat=5, rat=30)
# Fit parameters
