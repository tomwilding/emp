load("output/data/mix/mixBaselineData.RData")
require('epi')
# Simulate data 
# require('epi')
# Simulate data 
...
initConds <- c();
# initConds <- c(1,1,0)
plotConfig <- list(title="Synthedemic Decomposition of Simulated Data", fileName="output/graphs/mixBaseline/", dataFile="output/data/mix/mixData.RData", envFile="output/data/mix/mixEnv.RData", pat=20, rat=120)
