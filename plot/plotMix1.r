load("output/data/mix/mixDataFT1.RData")
require('epi')
# Simulate data 
# require('epi')
# ################################## Simulate data ########################################
...
# initParams <- c()
initParams <- c(log(0.001), log(0.01), log(10000), logit((34 - 40), (34 - 10), 34),
				log(0.001), log(0.01), log(10000), logit((103 - 40), (103 - 10), 103))
...
plotConfig <- list(title="Synthedemic Decomposition of Simulated Data", fileName="output/graphs/mixFT40/", dataFile="output/data/mix/mixData1.RData", envFile="output/data/mix/mixEnv.RData", pat=5, rat=30)
